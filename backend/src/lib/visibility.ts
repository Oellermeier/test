 ...
 */
export function canView(role: UserRole | undefined | null, visibility: Visibility): boolean {
  if (role === 'OWNER') return true
  if (!role) return visibility === 'PUBLIC'
  switch (visibility) {
 ...
 */
export function visibilityFilter(role: UserRole | undefined | null): Visibility[] {
  switch (role) {
